...
*
* @brief 			- This function is used to Enable or Disable the peripheral clock of USART.
*
...
* @fn 				- USART_Init
*
* @brief 			- This function initialize the given USART.
*
* @param[in] 		- Peripheral handle of the USART peripheral
* @param[in] 		-
* @param[in] 		-
*
* @return 			- None
...
* @fn 				- USART_SendData
*
* @brief 			- This function used to send data.
*
* @param[in] 		- Base address of the USART peripheral
* @param[in] 		- Data
...
* @fn 				- USART_SendDataIT
*
* @brief 			- This function used to send data with interrupt configuration.
*
* @param[in] 		- Base address of the USART peripheral
* @param[in] 		- Data
* @param[in] 		- Data Length
...
*
* @brief 			- This function used to receive data with interrupt configuration.
*
* @param[in] 		- Base address of the USART peripheral
* @param[in] 		- Data
* @param[in] 		- Data Length
...
*
* @brief 			- This function is configure Interrupt Handling for USART.
*
* @param[in] 		- pI2CHandle
* @param[in] 		-
* @param[in] 		-
...
//We dont discuss multibuffer communication in this code. Please refer to the RM.
...
*
* @brief 			- This function is used to Enable or Disable the USART Peripheral.
*
* @param[in] 		- Base address of the USART peripheral
* @param[in] 		- Enable or Disable
* @param[in] 		-
...
* @fn 				- I2C_ClearFlag
*
* @brief 			- This function used to clear flag by reading .... registers.
*
* @param[in] 		- Base address of the I2C peripheral
* @param[in] 		-
* @param[in] 		-
 ...
 *
 * @brief             - ApplicationEventCallback
 *
 * @param[in]         - USART Peripheral Handle
 * @param[in]         - Event
 * @param[in]         -
 *
 * @return            - None
